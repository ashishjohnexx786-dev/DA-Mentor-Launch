const CACHE='da-mentor-launch-v5.0';
const ASSETS=['./','./index.html','./styles.css','./curriculum.js','./app.js','./enhancements.js','./theme-picker.js','./manifest.webmanifest','./icon-192.svg','./icon-512.svg'];
